...
cell_dacbuffer.shapes(layout.layer(8, 0)).insert(_path)
...
cell_dacbuffer.shapes(layout.layer(30, 0)).insert(_path)
...
cell_dacbuffer.shapes(layout.layer(8, 25)).insert(
    pya.DText("VSS",
              pya.DTrans(0, False, pya.DVector(18.9, 0.25))))
cell_dacbuffer.shapes(layout.layer(30, 25)).insert(
    pya.DText("VSS",
...
cell_dacbuffer.shapes(layout.layer(30, 25)).insert(
    pya.DText("VDD",
              pya.DTrans(0, False, pya.DVector(18.9, 19.665))))
cell_dacbuffer.shapes(layout.layer(30, 25)).insert(
    pya.DText("VDD",
              pya.DTrans(0, False, pya.DVector(18.9, 22.895))))
cell_dacbuffer.shapes(layout.layer(30, 25)).insert(
    pya.DText("VSS",
              pya.DTrans(0, False, pya.DVector(18.9, 25.325))))
cell_dacbuffer.shapes(layout.layer(8, 25)).insert(
    pya.DText("VSS",
              pya.DTrans(0, False, pya.DVector(18.9, 25.94))))
