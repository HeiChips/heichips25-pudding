...
N 280 -260 320 -260 {lab=VDD}
N 280 -140 360 -140 {lab=C0}
N 360 -180 360 -140 {lab=C0}
N 280 -100 460 -100 {lab=C1}
...
C {iopin.sym} 280 -260 0 1 {name=p1 lab=VDD}
C {iopin.sym} 280 -140 0 1 {name=p2 lab=C0}
C {iopin.sym} 280 -100 0 1 {name=p3 lab=C1}
